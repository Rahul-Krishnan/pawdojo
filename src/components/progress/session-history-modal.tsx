  ...
  return (
    ...
    >
      <motion.div
        ...
        className="w-full max-w-sm rounded-t-3xl sm:rounded-3xl bg-surface-elevated dark:bg-dark-elevated border border-gray-100 dark:border-dark-border shadow-2xl max-h-[80dvh] flex flex-col"
      ...
      >
        ...
        <div
          className="overflow-y-auto px-5 pb-[calc(2rem+env(safe-area-inset-bottom))] sm:pb-5"
