  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center px-6 py-12">
      <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-primary-100">
        <PawIcon size={36} className="text-primary-600" />
      </div>
      <h1 className="mt-6 text-4xl font-bold font-heading tracking-tight text-gray-900">
        Goodboy
      </h1>
      ...
      <div className="mt-8 flex gap-6 text-center">
        <div className="flex flex-col items-center gap-1">
          ...
          <span className="text-xs font-medium text-gray-500">Streaks</span>
        </div>
        <div className="flex flex-col items-center gap-1">
